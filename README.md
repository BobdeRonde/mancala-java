# Status badge
![Pipeline status](https://git.sogyo.nl/bdronde/mancala-java/badges/cicd/pipeline.svg)
![Coverage report](https://git.sogyo.nl/bdronde/mancala-java/badges/cicd/coverage.svg)
